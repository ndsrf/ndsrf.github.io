(function ($) {
    ...
    var venueAddress = "Tomás Heredia 7, 29001, Málaga", // Venue Address
        eventInfo = [ "8 horas de conferencias en 2 tracks", "Ponencias gratuitas de varios MVPs", "En el centro de Málaga", "El Sábado 30 Mayo desde las 9:00 de la mañana", "Cervezas, tapas y networking post-evento", "Evento completamente gratuito, ¡sólo hay que registrarse!"]; // Event Info
